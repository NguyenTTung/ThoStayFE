...
interface Room {
  ...
  name: string;
  capacity: number;
  // thêm các thuộc tính của phòng khác nếu có
}
...
const MotelOwner = (props: { motel: Motel }) => {
  return (
    <>
      <div className="table-motel-index row mt-3 px-0 mx-0">
        ...
        <div className="phong-table-motel-owner col-7 col-sm-7 col-md-9 col-lg-10 col-xl-10 col-xxl-10 row">
          ...
          <button type="button" className="btn btn-primary w-10 h-10">
            Thêm phòng
          </button>
        </div>
      </div>
